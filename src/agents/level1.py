...
from src.tools.customer import search_customer_profile, get_identity_status, get_kyc_status
from src.tools.knowledge import search_policy_docs, multi_query_search
...
def level1_node(state: AgentState) -> dict:
    ...
    if any(w in request for w in ["identity", "verification", "verified", "unverified"]) and customer_id:
