...
_FORBIDDEN_PHRASES = [
    "buy shares", "invest in", "stock recommendation",
...
def guardrail_check(text: str, request_id: str = "") -> GuardrailResult:
    ...
    for phrase in _FORBIDDEN_PHRASES:
        if phrase in lower:
            ...
            revised = re.sub(re.escape(phrase), "[redacted]", revised, flags=re.IGNORECASE)
    ...
    if violations:
        ...
        return GuardrailResult(passed=False, violations=violations, revised_text=revised)
