...
This creates:
- `data/sales_transactions.json` — 229 sales transactions across 4 channels
- `data/social_media.json` — 79 social media posts with sentiment labels
- `data/support_tickets.json` — 58 support tickets with resolution times
...
```bash
jupyter notebook notebooks/level1_knowledge_agent.ipynb
```
