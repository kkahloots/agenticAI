# ⚙️ Level 3 — Functional / Lead Generation & Targeted Marketing

**TL;DR**: The functional layer executes business actions — lead scoring, customer enrichment, next-best-action recommendations, consent-gated notifications, identity-gated actions, bulk campaign targeting, and payment risk interventions.
...
- `notebooks/03_level3_functional.ipynb` - Interactive demo
