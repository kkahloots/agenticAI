...
```python
from nonagentic.tools.customer import get_customer_profile
...
```python
from nonagentic.tools.knowledge import search_emails
...
```python
from nonagentic.tools.knowledge import search_notes
...
```python
from nonagentic.tools.knowledge import search_policies
...
```python
from nonagentic.core.observability import log_audit
