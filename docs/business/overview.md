...
2. **Analytics Agent (Level 2)**: Performs data segmentation using K-means clustering, runs SQL queries, analyzes sentiment from social media, summarizes text, and generates visualizations.
   - **Demo**: `notebooks/level2_analytics_agent.ipynb`
   - **Status**: ✅ Fully implemented
   - **Features**:
...
- **Level 2**: `notebooks/level2_analytics_agent.ipynb` - Analytics, ML, and NLP
